...
const RecomendItem = ({product}: any) => {
  ...
  return (
    <div>
         <div
            className="bg-gray-300 rounded-2xl flex flex-col gap-2 p-6 font-bold"
          >
            <Image
              src={
            ...
            <h2 className="text-sm md:text-xl">
              {product?.attributes?.nameproduct}
            </h2>
            <h2 className="text-sm md:text-xl">
                    ...
                    <AlertDialogDescription>
                      <div className="flex flex-col md:flex-row gap-3">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <button className="font-bold items-center p-3 rounded-md bg-emerald-600 text-white" onClick={addToCart}>
                                Add To Cart
                          </button>
                        </div>
                      </div>
